...
class VendeurController {
    ...
    public function __construct(PDO $db) {
        ...
        if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'Admin') {
            header('Location: /dashboard-cafthe/public/dashboard/index');
            exit;
        }
    ...
    public function edit($id) {
        ...
        if (!$vendeur) {
            header('Location: /dashboard-cafthe/public/vendeurs');
            exit;
        }
    ...
    public function delete($id) {
        ...
        if ($id == $_SESSION['user_id']) {
            header('Location: /dashboard-cafthe/public/vendeurs?error=self_delete');
            exit;
        }

        $this->vendeurModel->deleteVendeur($id);
        header('Location: /dashboard-cafthe/public/vendeurs?success=deleted');
        exit;
    }
